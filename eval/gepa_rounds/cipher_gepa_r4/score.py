#!/usr/bin/env python3
"""Score GEPA round 4: 8 samples per program for reliable EM."""
import json, os
...
for b in batches:
    ...
    # char-level F1 for near-miss analysis
    char_correct = 0
    char_total = 0
...
print(f"Best: prog_{best['program_idx']} fitness={best['fitness']:.3f} EM={best['em']:.0%} char_acc={best['char_acc']:.0%}")
print(f"  {best['desc']}")
